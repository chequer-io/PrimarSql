...
internal class RelationPlanNode : PlanNode
{
    public override string Name => "Relation";
    ...
    public RelationPlanNode(Scope scope, FieldMapper mapper, PlanNode source, string sourceName, Expression?[] expressions) : base(scope)
    {
        _mapper = mapper;
        _source = source;
